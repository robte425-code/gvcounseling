              ...
              <div className="flex flex-wrap items-center gap-4 lg:gap-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <form action={emailVrcsForPayPeriodAction}>
                    ...
                    <ConfirmSubmitButton
                      confirmMessage={`Email VRCs for all billed clients in ${row.periodLabel}? Each VRC will receive session documentation (excluding invoice PDFs) with the session date(s).`}
