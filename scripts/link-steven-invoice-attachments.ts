/**
 * Link Steven BILLED invoice PDFs in Google Drive to InvoiceAttachment records.
 *
 * Usage: npx tsx scripts/link-steven-invoice-attachments.ts [--dry-run] [--use-cache]
...
const RESULTS_PATH = "scripts/link-steven-invoice-attachments-results.json";
const LOG_PATH = "scripts/link-steven-invoice-attachments-run.log";
